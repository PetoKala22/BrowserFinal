...
export const BrowserToolbar = memo<BrowserToolbarProps>(
  ({
    ...
    return (
      <div className="h-[42px] flex items-center w-full px-2 gap-2 electron-no-drag relative">
        ...
        <div className="flex items-center gap-1 min-w-[140px] justify-end pr-1 ml-auto z-10">
          ...
          <div className="ml-2 pl-2 border-l border-neutral-400/80 dark:border-neutral-600/70">
            <WindowControls />
          </div>
        </div>
      </div>
