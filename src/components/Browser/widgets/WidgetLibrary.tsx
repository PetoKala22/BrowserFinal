    ...
    <>
      <div className="absolute bottom-6 left-6 z-20">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-full border border-[color:var(--ui-border)] bg-[color:var(--ui-surface)] px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--ui-text)] shadow-lg backdrop-blur-xl shadow-black/5 transition hover:bg-[color:var(--ui-hover)]"
        >
          <MdAdd size={16} />
          Widget
        </button>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-[color:var(--ui-border)] bg-[color:var(--ui-surface-strong)] px-3 py-2 text-xs text-[color:var(--ui-text)]">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="rounded-full px-2.5 py-1 text-[0.6rem] font-semibold uppercase tracking-[0.2em] text-[color:var(--ui-text-muted)] transition hover:bg-[color:var(--ui-hover)]"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="rounded-full bg-[color:var(--ui-accent)] px-2.5 py-1 text-[0.6rem] font-semibold uppercase tracking-[0.2em] text-[color:var(--ui-accent-contrast)] transition hover:brightness-95"
                  >
                    Remove
                  </button>
                </div>
